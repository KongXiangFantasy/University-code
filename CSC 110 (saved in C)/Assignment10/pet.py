...
class Pet:
    ...
    def __eq__(self, other: 'Date') -> bool:
        ...
        >>> self = Pet('Rover', 'Dog', Date(12, 19, 2020))
        >>> other = Pet('Rover', 'Dog', Date(12, 19, 2020))
        >>> self == other
        True
        >>> self = Pet('Rover', 'Dog', Date(12, 19, 2020))
        >>> other = Pet('Rover', 'Dog', Date(11, 19, 2020))
        >>> self == other
        False
        >>> self = Pet('Rover', 'Cat', Date(12, 19, 2020))
        >>> other = Pet('Rover', 'Dog', Date(12, 19, 2020))
        >>> self == other
        False
        >>> self = Pet('Richard', 'Dog', Date(12, 19, 2020))
        >>> other = Pet('Rover', 'Dog', Date(12, 19, 2020))
        >>> self == other
        False
        """
